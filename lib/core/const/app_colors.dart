...
class AppLightColors {
  ...
  static const Color neonGreen = Color(0xff61FF00);

  // Backgrounds
  static const Color bg = Color(0xffF9FAFB);
  static const Color appbar = Color(0xffFFFFFF);
  static const Color container = Color(0xffF3F4F6);
  ...
  // Chat Bubble Colors
  static const myBubble = Color(0xFFCFE0FF);
  static const otherBubble = Color(0xFFF1F3F5);
}
