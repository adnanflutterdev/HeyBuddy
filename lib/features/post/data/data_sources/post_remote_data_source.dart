...
import 'package:hey_buddy/features/post/data/models/reaction.dart';
...
class PostRemoteDataSource {
  ...
  Future<void> uploadFeedItem(PostModel post) async {
    await firestore
        .collection('post')
        .doc(post.id)
        .set(post.toFirebase());
  ...
  Future<void> addComment(String postId, Comment comment) async {
    firestore
        ...
        .collection('comments')
        .doc(comment.id)
        .set((comment as CommentModel).toFirebase());
  }
  ...
  Future<void> addReaction({
    ...
    firestore
        ...
        .doc(reaction.userId)
        .set((reaction as ReactionModel).toFirebase());
  }
}
